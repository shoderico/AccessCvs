...
class UTIL_SHARED_EXPORT SettingNode
{
public:
    enum NodeType
    {
...
class UTIL_SHARED_EXPORT SettingKeyValue : public SettingNode
{
public:
...
class UTIL_SHARED_EXPORT SettingElement : public SettingNode
{
public:
...
class UTIL_SHARED_EXPORT Setting : public SettingElement
{
public:
