...
AccessCvs provides integration tools and add-ins for version control (CVS/Git) with Microsoft Access and Excel, built using Qt.
...
This is a multi-project Qt solution (`AccessTools.pro`) containing subprojects for:
